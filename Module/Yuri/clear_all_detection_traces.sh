...
echo "\033[41mHolmes files have been cleared\033[0m"
sleep 0.5

rm -rf /storage/emulated/0/Android/data/com.zhenxi.hunter
echo "\033[41mHunter files have been cleared\033[0m"
sleep 0.5

rm -rf /storage/emulated/0/Android/data/icu.nullptr.nativetest
echo "\033[41mNative Test files have been cleared\033[0m"
sleep 0.5

rm -rf /storage/emulated/0/Android/data/com.byyoung.setting
rm -rf /data/property/
echo "\033[41mAiWanJi Toolbox files have been cleared\033[0m"
sleep 0.5
...
echo "\033[41mMT Manager folder has been cleaned\033[0m"
sleep 0.5
...
rm -rf /storage/emulated/0/.anydesk/
