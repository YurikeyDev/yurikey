...
[更新履歴](https://raw.githubusercontent.com/dpejoh/yurikey/main/changelog.md)
...
> [!NOTE]
>
> action.sh またはモジュールのインストール時に以下のエラーが発生した場合は、以下のモジュールをインストールする必要があります。
>

"ERROR: Tricky Store module not found!" のエラーが発生した場合
> [Tricky Store](https://github.com/5ec1cff/TrickyStore/releases/latest)

"ERROR: curl or wget not found!" のエラーが発生した場合
